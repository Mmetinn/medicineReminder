...
public class vucutSicakligiActivity extends AppCompatActivity {

    LineGraphSeries<DataPoint> series;
    SimpleDateFormat dateFormat= new SimpleDateFormat("dd MMM");
    SimpleDateFormat dateFormatTx= new SimpleDateFormat("yyyy-MM-dd HH:mm");
    EditText etAciklama,etSeker;
    String vucutSicakligi,aciklama,tarih;
    ScrollView scrollView;
    GraphView graphView;
    LinearLayout linnear;

    ilacSaatiDB DB = new ilacSaatiDB(vucutSicakligiActivity.this);
    private static final String VUCUTSICAKLIGI_ID="9";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vucut_sicakligi);
        TextView tx;
        ...
        etSeker = (EditText) findViewById(R.id.vucutSicakligiEt);
        ...
        ArrayList<String> arrayList=DB.DBArrayOlcum(VUCUTSICAKLIGI_ID);
    ...
    private void createCardAll() {
        ...
        ArrayList<String>array=db.DBArrayOlcum(VUCUTSICAKLIGI_ID);
        int sayac=0;
        while (sayac<array.size()){
            String dizi[]=array.get(sayac).split("--");
            CardView cv = new CardView(vucutSicakligiActivity.this);
    ...
    public void grafik(){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                String mesaj = dataPoint.getY() + " adım";
    ...
    private DataPoint[] getDataPoint(){
        ilacSaatiDB DB = new ilacSaatiDB(this);
        DataPoint[]dp=DB.DBArrayOlcumXY(VUCUTSICAKLIGI_ID);
        return dp;
    }

    public void vucutSicakligiKaydetClicked(View view){
        vucutSicakligi=etSeker.getText().toString();
        aciklama=etAciklama.getText().toString();
        tarih=dateFormatTx.format(new Date().getTime());

        olcum_class olcum = new olcum_class(vucutSicakligi,aciklama,VUCUTSICAKLIGI_ID,tarih);
