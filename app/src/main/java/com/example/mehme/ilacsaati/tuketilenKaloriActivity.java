...
public class tuketilenKaloriActivity extends AppCompatActivity {
    ...
    ilacSaatiDB DB = new ilacSaatiDB(tuketilenKaloriActivity.this);
    private static final String TUKETILENKALORI_ID="6";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tuketilen_kalori);
        TextView tx;
        ...
        etSeker = (EditText) findViewById(R.id.tuketilenKaloriEt);
        ...
        ArrayList<String> arrayList=DB.DBArrayOlcum(TUKETILENKALORI_ID);
    ...
    private void createCardAll() {
        ...
        ArrayList<String>array=db.DBArrayOlcum(TUKETILENKALORI_ID);
        int sayac=0;
        while (sayac<array.size()){
            String dizi[]=array.get(sayac).split("--");
            CardView cv = new CardView(tuketilenKaloriActivity.this);
    ...
    private DataPoint[] getDataPoint(){
        ilacSaatiDB DB = new ilacSaatiDB(this);
        DataPoint[]dp=DB.DBArrayOlcumXY(TUKETILENKALORI_ID);
        return dp;
    }

    public void kaloriKaydetClicked(View view){
        kalori=etSeker.getText().toString();
        aciklama=etAciklama.getText().toString();
        tarih=dateFormatTx.format(new Date().getTime());

        olcum_class olcum = new olcum_class(kalori,aciklama,TUKETILENKALORI_ID,tarih);
