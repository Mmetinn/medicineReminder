...
public class kolestrolActivity extends AppCompatActivity {
    LineGraphSeries<DataPoint> series;
    SimpleDateFormat dateFormat= new SimpleDateFormat("dd MMM");
    SimpleDateFormat dateFormatTx= new SimpleDateFormat("dd MMM HH:MM");
    EditText etAciklama,etSeker;
    String kolestrol,aciklama,tarih;
    ScrollView scrollView;
    GraphView graphView;
    LinearLayout linnear;

    ilacSaatiDB DB = new ilacSaatiDB(kolestrolActivity.this);
    private static final String KOLESTROL_ID="8";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kolestrol);
        TextView tx;
        ...
        etSeker = (EditText) findViewById(R.id.kolestrolEt);
        ...
        ArrayList<String> arrayList=DB.DBArrayOlcum(KOLESTROL_ID);
    ...
    private void createCardAll() {
        ...
        ArrayList<String>array=db.DBArrayOlcum(KOLESTROL_ID);
        int sayac=0;
        while (sayac<array.size()){
            String dizi[]=array.get(sayac).split("--");
            CardView cv = new CardView(kolestrolActivity.this);
    ...
    public void grafik(){
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                String mesaj = dataPoint.getY() + " birim";
    ...
    private DataPoint[] getDataPoint(){
        ilacSaatiDB DB = new ilacSaatiDB(this);
        DataPoint[]dp=DB.DBArrayOlcumXY(KOLESTROL_ID);
        return dp;
    }

    public void kolestrolKaydetClicked(View view){
        kolestrol=etSeker.getText().toString();
        aciklama=etAciklama.getText().toString();
        tarih=dateFormatTx.format(new Date().getTime());

        olcum_class olcum = new olcum_class(kolestrol,aciklama,KOLESTROL_ID,tarih);
